...
local love = {
   fields = {
      ...
      audio = def_fields("getActiveEffects","getActiveSourceCount","getDistanceModel",
         ...
         "setVelocity","setVolume","stop"),

      data = def_fields("compress","decode","decompress","encode","hash"),
      ...
      graphics = def_fields("arc","applyTransform","captureScreenshot","circle","clear","discard",
         ...
         "getBlendMode","getCanvas","getCanvasFormats","getColor","getColorMask","getDefaultFilter",
         "getDepthMode","getDimensions","getFont","getFrontFaceWinding","getHeight",
         "getImageFormats","getLineJoin","getLineStyle","getLineWidth","getMeshCullMode",
         "getShader","getStackDepth","getStats","getStencilTest","getSupported","getSystemLimits",
         "getPointSize","getRendererInfo","getScissor","getTextureTypes","getWidth",
         "intersectScissor","inverseTransformPoint","isGammaCorrect","isWireframe","line",
         "newCanvas","newFont","newMesh","newImage","newImageFont","newParticleSystem","newShader",
         "newText","newQuad","newSpriteBatch","newVideo","origin","points","polygon","pop",
         "present","print","printf","push","rectangle","replaceTransform","reset","rotate","scale",
         "setBackgroundColor","setBlendMode","setCanvas","setColor","setColorMask",
